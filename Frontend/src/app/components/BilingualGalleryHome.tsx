...
export function BilingualGalleryHome() {
  ...
  const featuredArtworks = [
    {
      ...
      notes: [t('note.amber'), t('note.vanilla'), t('note.tobacco')],
      isNew: true,
    },
    {
      id: 'oud-royal',
      ...
      notes: [t('note.oud'), t('note.rose'), t('note.saffron')],
    },
    {
      id: 'rose-mystique',
      ...
      year: '2026',
      concentration: 'Eau de Parfum',
      notes: [t('note.rose'), t('note.jasmine'), t('note.musk')],
    },
  ];

  const scentNotes = [
    { name: t('note.oud'), nameAr: 'عود', count: 12 },
    { name: t('note.amber'), nameAr: 'عنبر', count: 8 },
    { name: t('note.musk'), nameAr: 'مسك', count: 15 },
    { name: t('note.rose'), nameAr: 'ورد', count: 10 },
    { name: t('note.jasmine'), nameAr: 'ياسمين', count: 7 },
    { name: t('note.sandalwood'), nameAr: 'صندل', count: 9 },
  ];

  const testimonials = [
    {
      text: language === 'en' 
        ? 'A masterpiece in a bottle. The craftsmanship is evident in every note.'
        : 'تحفة فنية في زجاجة. الحرفية واضحة في كل نوتة.',
      author: 'Sarah Al-Mansoori',
      authorAr: 'سارة المنصوري',
    },
    {
      text: language === 'en'
        ? 'Kahramana creates art you can wear. Truly exceptional.'
        : 'كهرمانة تخلق فناً يمكنك ارتداؤه. استثنائية حقاً.',
      author: 'Omar Hassan',
      authorAr: 'عمر حسن',
    },
    {
      text: language === 'en'
        ? 'The most elegant and sophisticated fragrances I have experienced.'
        : 'أكثر العطور أناقة وتطوراً التي جربتها.',
      author: 'Layla Rahman',
      authorAr: 'ليلى رحمن',
    },
  ];
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-12 text-center">
          ...
          >
            ...
            <motion.h1
              ...
              className={`text-5xl sm:text-6xl lg:text-8xl mb-6 leading-[1.1] text-[#101010] ${
            ...
            >
              <Link to="/shop">
                <GalleryButton size="lg">{t('home.cta.explore')}</GalleryButton>
              </Link>
              <Link to="/shop">
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12 max-w-[1800px] mx-auto">
        ...
        >
          ...
          <h2 className={`text-4xl lg:text-6xl text-[#101010] mb-4 ${language === 'ar' ? 'font-arabic' : 'font-display'}`}>
        ...
        <div className="text-center mt-16">
          <Link to="/shop">
            <GalleryButton variant="text">
              ...
              <ArrowRight className={language === 'ar' ? 'mr-2 rotate-180' : 'ml-2'} size={16} />
            </GalleryButton>
          </Link>
        </div>
      </section>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12 max-w-[1800px] mx-auto border-y border-[#E8E5E0]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 lg:gap-8">
          {scentNotes.map((note, index) => (
            ...
            >
              <h3 className={`text-2xl text-[#101010] mb-2 group-hover:text-[#EC4899] transition-colors ${language === 'ar' ? 'font-arabic' : 'font-display'}`}>
                {language === 'ar' ? note.nameAr : note.name}
              </h3>
              <p className="text-xs text-[#A0A0A0]">
                {note.count} {t('home.notes.artworks')}
              </p>
            </motion.button>
          ))}
        </div>
      ...
      {/* Curator's Story */}
      <section className="py-24 lg:py-32 px-6 lg:px-12 max-w-[1800px] mx-auto">
        <div className={`grid lg:grid-cols-2 gap-16 lg:gap-24 items-center ${language === 'ar' ? 'lg:grid-flow-dense' : ''}`}>
          {/* Image */}
          <motion.div
            ...
            className={`relative ${language === 'ar' ? 'lg:col-start-2' : 'order-2 lg:order-1'}`}
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className={language === 'ar' ? 'lg:col-start-1' : 'order-1 lg:order-2'}
          >
            <p className="text-xs tracking-[0.3em] uppercase text-[#A0A0A0] mb-6">
              {t('home.story.label')}
            </p>
            <h2 className={`text-4xl lg:text-6xl text-[#101010] mb-8 leading-tight ${language === 'ar' ? 'font-arabic' : 'font-display'}`}>
              {t('home.story.title')}
              <span className="block mt-2 gradient-text">{t('home.story.subtitle')}</span>
            </h2>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12 max-w-[1800px] mx-auto">
        ...
        >
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            <p className="text-xs tracking-[0.3em] uppercase text-[#A0A0A0] mb-6">
              {t('home.limited.label')}
            </p>
            <h2 className={`text-4xl lg:text-7xl text-[#101010] mb-6 leading-tight ${language === 'ar' ? 'font-arabic' : 'font-display'}`}>
              {t('home.limited.title')}
            </h2>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12 max-w-[1800px] mx-auto">
        ...
        >
          ...
          <h2 className={`text-4xl lg:text-6xl text-[#101010] ${language === 'ar' ? 'font-arabic' : 'font-display'}`}>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12 max-w-[1800px] mx-auto border-t border-[#E8E5E0]">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {[
            {
              title: language === 'en' ? 'The Art of Layering' : 'فن الطبقات',
              date: language === 'en' ? 'January 2026' : 'يناير ٢٠٢٦',
              excerpt: language === 'en' 
                ? 'Discover how to combine fragrances to create your unique signature...'
                : 'اكتشف كيفية دمج العطور لخلق توقيعك الفريد...',
            },
            {
              title: language === 'en' ? 'Understanding Oud' : 'فهم العود',
              date: language === 'en' ? 'December 2025' : 'ديسمبر ٢٠٢٥',
              excerpt: language === 'en'
                ? 'An exploration of the most precious ingredient in perfumery...'
                : 'استكشاف المكون الأثمن في صناعة العطور...',
            },
            {
              title: language === 'en' ? 'Perfume Rituals' : 'طقوس العطور',
              date: language === 'en' ? 'November 2025' : 'نوفمبر ٢٠٢٥',
              excerpt: language === 'en'
                ? 'Creating meaningful moments through the art of fragrance...'
                : 'خلق لحظات ذات مغزى من خلال فن العطور...',
            },
          ].map((article, index) => (
            <motion.article
              key={index}
            ...
            >
              ...
              <h3 className={`text-2xl text-[#101010] mb-3 group-hover:text-[#EC4899] transition-colors ${language === 'ar' ? 'font-arabic' : 'font-display'}`}>
                {article.title}
              </h3>
